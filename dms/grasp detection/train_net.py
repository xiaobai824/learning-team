...
from atss_core.data import CornellDataset
...
path = '/home/data5_2.5/account/dongmingshuai/cornell_datasets/cornell_grasp_data'
...
def run_test(cfg, model, distributed):
    ...
    dataset_val = CornellDataset(path, train=False)
    data_loader_val = Data.DataLoader(dataset_val, batch_size=5)
